...
This open source, reproducible vignette is for a four-day invited short course
on use of the Targeted Learning framework for statistical and causal inference
with machine learning in modern "Big Data" applications. Beyond introducing
Targeted Learning, the course focuses on applying the methodology in practice
...
discussion of these topics and much more, and may serve as a useful reference to
accompany these workshop materials.
...
* __Software installation__: Please install the relevant software before the
  ...
  script](https://github.com/tlverse/tmlcimx2021-workshop/blob/master/install.R).
...
_Targeted Learning_ for causal inference, and the corresponding [`tlverse`
software ecosystem](https://github.com/tlverse). Emphasis will be placed on
targeted minimum loss-based estimators of the causal effects of single timepoint
