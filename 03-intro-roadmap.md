...
In order to start learning from the data, we next need to ask ***"What do we 
know about the probability distribution of the data?"*** This brings us on to 
Step 2.
...
<img src="03-intro-roadmap_files/figure-html/simple-DAG-1.png" width="80%" style="display: block; margin: auto;" />
